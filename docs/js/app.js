...
let IngredientItem = class IngredientItem extends s {
    constructor() {
        super(...arguments);
        this.name = "ingredient_name";
        this.initialQuantity = 0;
        this.initialServings = 10;
        this.unit = "";
        this.currentServings = undefined;
    }
    render() {
...
__decorate$1([
    e$3({ type: Number })
], IngredientItem.prototype, "initialQuantity", void 0);
__decorate$1([
    e$3({ type: Number })
], IngredientItem.prototype, "initialServings", void 0);
__decorate$1([
    e$3()
], IngredientItem.prototype, "unit", void 0);
__decorate$1([
    e$3()
], IngredientItem.prototype, "currentServings", void 0);
IngredientItem = __decorate$1([
    n$4('ingredient-item')
], IngredientItem);
let IngredientList = class IngredientList extends s {
    constructor() {
        super(...arguments);
        this.servingNumber = 5;
    }
    render() {
        return p `
...
], IngredientList.prototype, "servingNumber", void 0);
__decorate$1([
    i$2('#servinginput')
], IngredientList.prototype, "input", void 0);
__decorate$1([
    i$2('#ingredientslot')
], IngredientList.prototype, "ingredientslot", void 0);
IngredientList = __decorate$1([
    n$4('ingredient-list')
], IngredientList);
...
export { IngredientItem, IngredientList, logHello };
